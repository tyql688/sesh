...
impl CursorProvider {
    ...
    /// ProjectKey format: Users-yuqingyu-Documents-drama-aitool (dashes replace path separators)
    ///
...
/// e.g. "Users-yuqingyu-Documents-drama-aitool" → "/Users/yuqingyu/Documents/drama/aitool"
///
